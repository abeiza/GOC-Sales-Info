...
function loadAllSales(){
	...
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_sales_all/",
		cache:false,
...
function loadDetailSales(){
	var id_data = '<?php echo $this->session->userdata('id');?>';
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_sales_detail/",
		cache:false,
		data:"id_data="+id_data,
		type: "POST",
		dataType: 'json',
...
function loadCall(){
	var id_data = '<?php echo $this->session->userdata('id');?>';
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_call/",
		cache:false,
		data:"id_data="+id_data,
		type: "POST",
		dataType: 'json',
...
function loadEC(){
	var id_data = '<?php echo $this->session->userdata('id');?>';
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_ec/",
		cache:false,
		data:"id_data="+id_data,
		type: "POST",
		dataType: 'json',
...
function loadAllSalesSearch(){
	...
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_sales_all_search/",
		cache:false,
		data: {
				"id_data": id_data, 
				"ymd": ymd
...
function loadDetailSalesSearch(){
	...
	var ymd = $("#transdte").val();
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_sales_detail_search/",
		cache:false,
		data: {
				"id_data": id_data, 
				"ymd": ymd
...
function loadCallSearch(){
	...
	var ymd = $("#transdte").val();
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_call_search/",
		cache:false,
		data: {
				"id_data": id_data, 
				"ymd": ymd
...
function loadECSearch(){
	...
	var ymd = $("#transdte").val();
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_ec_search/",
		cache:false,
		data: {
				"id_data": id_data, 
				"ymd": ymd
			...
			<div style="width:100%;">
				<div class="box-flat" style="float:left;width:100%;">
					<div id="period" style="padding:5%;padding-bottom:10px;">
						...
						<span style="color:#46b7bf;font-size:12px;">Tanggal Transaksi : <?php echo date('d-m-Y');?></span>
					</div>
				</div>
