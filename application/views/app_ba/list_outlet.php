	...
	<div class="header-dashboard" style="height:54px !important; min-height:54px !important;">
		<div style="width:100%;position:absolute;z-index:99999;">
			<div class="content">
				...
				<div style="color:#fff;font-family:'Quicksand-Bold' !important;padding-top:17px;text-align:center;width:90%;float:left;">Daftar Toko</div>
									...
									foreach($query1->result() as $outlet){
										...
										<li>
											<div style="padding:10px 0;">
												...
												<p style="padding-top:0;padding-bottom:0;margin:0;"><?php echo 'Wilayah : '.ucwords(strtolower($outlet->COVERAGE_OUTLET));?></p>
												<p style="padding-top:0;padding-bottom:0;margin:0;"><?php echo 'Kota : '.ucwords(strtolower($outlet->CITY_OUTLET));?></p>
											</div>
										</li>
										<?php
									}
