	...
	<div class="header-dashboard" style="height:54px !important; min-height:54px !important;">
		<div style="width:100%;position:absolute;z-index:99999;">
			<div class="content">
				...
				<div style="color:#fff;font-family:'Quicksand-Bold' !important;padding-top:17px;text-align:center;width:90%;float:left;">Daftar Produk Baru</div>
									...
									foreach($query1->result() as $product){
										...
										<li>
											<div style="padding:10px 0;">
												<a href="#" style="padding-top:0;padding-bottom:0;"><?php echo $product->DESCRIPTION_PRINCIPLE;?></a>
												<span style="font-size:12px;color:#46b7bf;"><?php echo 'Kode Produk : '.$product->PRODUCT_KODE_PRINCIPLE;?></span>
											</div>
										</li>
										<?php
									}
