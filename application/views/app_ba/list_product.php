...
<script>
	function modify_data(e){
		...
		if($("#" + element).is(':checked')){
			//alert('check');
			$.ajax({
				url:"<?php echo base_url();?>index.php/apps/add_cart/<?php echo $this->uri->segment(3);?>",
				cache:false,
				data:{
					id:element
				},
			...
			//alert('uncheck');
			$.ajax({
				url:"<?php echo base_url();?>index.php/apps/delete_cart/<?php echo $this->uri->segment(3);?>",
				cache:false,
				data:{
					id:element
				},
...
<div class="container">
	<div class="header-dashboard" style="height:54px !important; min-height:54px !important;">
		<div style="width:100%;position:absolute;z-index:99999;">
			<div class="content">
				<a href="<?php echo base_url();?>index.php/apps/cart/<?php echo $this->uri->segment(3);?>">
				...
				<div class="box-flat" id="products">
					<div style="padding: 1% 5%;">					
						<div style="margin-top:13px;">
							<label style="width:100%;margin-bottom:0px;font-family:'Quicksand-Bold' !important">Cari Produk  <i class="fa fa-exclamation-circle" style="color:#ff8f00;font-size:15px;" data-toggle="tooltip" data-placement="right" title="Isilah kolom di bawah ini untuk mempermudah dalam pencarian produk"></i></label>
						...
						<div>
							<div>
								<label style="padding-top:10px;font-family:'Quicksand-Bold' !important">Daftar Produk</label>
							</div>
												...
												<li>
													<div>
														...
														<label for="<?php echo $prd->ID_PRODUCT;?>" style="width:80%;">
															...
															<div style="font-size:12px !important;" class="principle">Kode Produk : <?php echo $prd->PRODUCT_KODE_PRINCIPLE;?></div>
							...
							<div style="position:fixed;bottom:20px;right:25px;z-index:99999;">
								<a href="<?php echo base_url();?>index.php/apps/cart/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>" name="add_cart" style="font-family:'Quicksand-Bold' !important;border:none;padding:16px 12px;text-align:center;cursor:pointer;box-shadow:0 2px 2px 0 rgba(0,0,0,.5), 0 3px 1px -2px rgba(0,0,0,.08), 0 1px 5px 0 rgba(0,0,0,.08);background:#ff8f00;color:#fff;border-radius:100%;float:left;opacity:0.8;"><i class="fa fa-check fa-2x color-white"></i><br/><span style="color:#fff;font-size:12px !important;">Lanjutkan</span></a>
							</div>
