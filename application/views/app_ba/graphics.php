...
<script>
	$(function(){
		$(function(){
			var m = $("#month").val();
			var y = $("#year").val();
			$("#graph").attr("href","http://192.168.171.116/sg_mobile/index.php/apps/graphics/"+y+"/"+m);
		});
...
$(function () {
    $(document).ready(function () {
        ...
        $('#container').highcharts({
            ...
            title: {
                     text: 'Grafik Penjualan Produk dalam Nominal'
			},
			tooltip: {
            ...
            series: [{
                ...
                data: [
					<?php 
						$query_value=$this->db->query("select NAMA_TIPE_PRODUCT, sum(VALUE) as Amount_Tipe_Product from View_EVAN_Qlik_SellOut 
where ID_TIPE_PRODUCT NOT IN ('HSL','PRO') and ID_BA='".$id."' and Tahun='".$this->uri->segment(3)."' and Bulan='".$this->uri->segment(4)."' group by NAMA_TIPE_PRODUCT order by NAMA_TIPE_PRODUCT desc");
		...
		$('#container1').highcharts({
            ...
            title: {
                 text: 'Grafik Penjualan Produk dalam Qty'
            },
            tooltip: {
            ...
            series: [{
                ...
                data: [
					<?php 
						$query_value1=$this->db->query("select NAMA_TIPE_PRODUCT, sum(Qty) as Qty_Tipe_Product from View_EVAN_Qlik_SellOut 
...
<div class="container" style="background-color:#f9f9f9 !important;">
	<div class="header-dashboard" style="height:54px !important; min-height:54px !important;">
		<div style="width:100%;position:absolute;z-index:99999;">
			<div class="content">
				<a href="<?php echo base_url();?>index.php/apps/recapt_sales/">
			...
			<div style="width:100%;">
				...
				<div class="box-flat">
					<div style="padding:5%;padding-bottom:10px;padding-top:0;">
						...
						<a id="graph" style="width:19%;margin-left:1%;border:none;background-color: #ff8f00;color: #fff !important;float: Left;text-align: center;border-radius: 3px;width: auto !important;padding: 10px;">Filter</a>
					</div>
				</div>
