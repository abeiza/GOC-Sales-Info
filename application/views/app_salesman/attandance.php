...
function loadDetailAbsensi(){
	...
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_detail_absensi_salesman/",
		cache:false,
...
function loadAllAbsensi(){
	var id_data = '<?php echo $this->session->userdata('id');?>';
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_all_absensi_salesman/",
		cache:false,
		data:"id_data="+id_data,
		type: "POST",
		dataType: 'json',
...
function loadDetailAbsensiSearch(){
	var id_data = '<?php echo $this->session->userdata('id');?>';
	var month = $("#month").val();
	var year = $("#year").val();
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_detail_absensi_salesman_search/",
		cache:false,
		data:{
				"id_data": id_data, 
				"month": month,
...
function loadAllAbsensiSearch(){
	var id_data = '<?php echo $this->session->userdata('id');?>';
	var month = $("#month").val();
	var year = $("#year").val();
	$.ajax({
		url:"<?php echo base_url();?>index.php/apps/get_all_absensi_salesman_search/",
		cache:false,
		data:{
				"id_data": id_data, 
				"month": month,
...
$(function(){
	...
	$("#search-btn").click(function(){
		...
		loadAllAbsensiSearch();
		loadDetailAbsensiSearch();
	});
			...
			<div style="width:100%;">
				...
				<div class="box-flat">
					...
					<label style="float:Left;width:20%;padding:15px 0;">Bulan : </label>
						...
						<button id="search-btn" style="border:none;background-color: #ff8f00;color: #fff !important;float: Left;text-align: center;border-radius: 3px;width: auto !important;padding: 10px;">Filter</button>
					</div>
				</div>
