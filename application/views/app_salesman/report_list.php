	...
	<div class="header-dashboard" style="height:54px !important; min-height:54px !important;">
		<div style="width:100%;position:absolute;z-index:99999;">
			<div class="content">
				...
				<div style="color:#fff;font-family:'Quicksand-Bold' !important;padding-top:17px;text-align:center;width:90%;float:left;">Kinerja Salesman</div>
			...
			<div style="width:100%;">
						...
						<div class="panel-group">
								...
								<div id="collapse1" class="panel-collapse collapse in">
									<ul id="sales_detail" class="list-group" style="border:none !important;">
										<li class="list-group-item" style="border-bottom:none;border-top:1px dashed #ddd">
											<span><a href="<?php echo base_url();?>index.php/apps/recapt_sales_daily_salesman/">per Hari</a></span>
										</li>
										<li class="list-group-item" style="border-bottom:none;border-top:1px dashed #ddd">
											<span><a href="<?php echo base_url();?>index.php/apps/recapt_sales_salesman/">per Bulan</a></span>
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="panel panel-default" style="border:none;box-shadow:none;">
								<div id="sales_call" class="panel panel-heading" style="background-color:#fff;border:none;box-shadow:none;">
									<h4 class="panel-title">
										<a href="<?php echo base_url();?>index.php/apps/attendance_salesman/" style="font-family:'Quicksand-bold' !important;" href="#collapse2">Absensi</a>
									</h4>
								</div>
							</div>
				...
				<!--<div class="box-flat">	
						<ul>
							<li>
								<div>
									<a href="<?php //echo base_url();?>index.php/apps/recapt_sales_salesman/">REKAPITULASI PENJUALAN</a>
								</div>
							</li>
							<li>
								<div>
									<a href="<?php //echo base_url();?>index.php/apps/attendance_salesman/">REKAPITULASI ABSENSI</a>
								</div>
							</li>
						</ul>
				</div>-->
